        ...
        <div class="navbar-collapse collapse w-150 order-3 order-md-2 dual-collapse2">
          <ul class="navbar-nav mx-auto">
            <NavDropdown title="PRICE" id="collasible-nav-dropdown">
              <NavDropdown.Item href="#action/3.1">Rp. 0 - 1.000.000</NavDropdown.Item>
                <NavDropdown.Item href="#action/3.2">Rp. 1.000.000 - 5.000.000- </NavDropdown.Item>
                <NavDropdown.Item href="#action/3.3">Rp. 5.000.000 - .........</NavDropdown.Item>
            </NavDropdown>
          </ul>
        </div>
      </nav>
      ...
      <Container>
        ...
        <Row>
          ...
          <Card style={{ width: '400px' ,top:'20px'}}>
            ...
            {/* Image  */}
            <Row>
            <Card.Img variant="top" src="kursi.jpeg" />
            </Row>
            {/* Title */}
            <Row>
            <Card.Body>
                <Card.Title>Single Chair</Card.Title>
              </Card.Body>
            </Row> 
            {/* Info */}
         ...
         <Col>
          <Card style={{ width: '400px' ,top:'20px'}}>
            ...
            {/* Image  */}
            <Row>
            <Card.Img variant="top" src="meja.jpeg" />
            </Row>
            {/* Title */}
            <Row>
            <Card.Body>
                <Card.Title>Single Table</Card.Title>
              </Card.Body>
            </Row> 
            {/* Info */}
            <Row className="mt-4 mb-4">
          ...
          <Card style={{ width: '400px' ,top:'20px'}}>
            ...
            {/* Image  */}
            <Row>
            <Card.Img variant="top" src="wardrobe.jpeg" />
            </Row>
            {/* Title */}
            <Row>
            <Card.Body>
                <Card.Title>Modern Wardrobe</Card.Title>
              </Card.Body>
            </Row> 
            {/* Info */}
            <Row className="mt-4 mb-4">
